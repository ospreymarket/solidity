...
import "./Core/CTokenInterfaces.sol";
import "./InterestRate/InterestRateModel.sol";
import "./External/EIP20Interface.sol";
import "./External/ExponentialNoError.sol";
    ...
    TokenErrorReporter
{
     ...
     * @param comptroller__ The address of the Comptroller
     ...
     */
    function initialize(
        ComptrollerInterface comptroller__,
        ...
        // Set the comptroller
        uint err = _setComptroller(comptroller__);
    ...
    /**
     * @notice The sender iquidates the borrowers collateral.
    ...
    function liquidateBorrowInternal(
        address borrower,
        uint repayAmount,
        CTokenInterface pTokenCollateral
    ) internal nonReentrant {
        accrueInterest();
